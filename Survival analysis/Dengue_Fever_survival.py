...
Original file is located at
    https://colab.research.google.com/drive/1IO_MajUkHT_pRk1f_VjishDVT367aQb2
...
data = pd.read_csv("/content/drive/MyDrive/Bahan port/Survival Analysis/lung.csv", index_col = 0)
data.head()
